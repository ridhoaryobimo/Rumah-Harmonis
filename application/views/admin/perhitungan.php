<div class="col-xs-12">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<hr>
			<div class="panel-info">
				<div class="panel-heading">Detail Penjurusan Bahasa</div>
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						<tr>
							<th>No</th>
			...
			<div class="panel-info">
				<div class="panel-heading">Detail Penjurusan IPA</div>
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						<tr>
							<th>No</th>
			...
			<div class="panel-info">
				<div class="panel-heading">Detail Penjurusan IPS</div>
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						<tr>
							<th>No</th>
			...
			<hr>
			<div class="panel-info">
				<div class="panel-heading">Hasil Seleksi Vektor V Bahasa</div>
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						<tr>
							<th>No</th>
						...
						<?php $i=1; foreach ($hasil_seleksi_jurusan_bhs as $key) { ?>
						<tr>
							<td><?php echo $i; ?></td>
							<td><?php echo $key->nama_siswa; ?></td>
							<td><?php echo $key->vektor_s; ?></td>
				...
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						...
						<?php $i=1; foreach ($hasil_seleksi_jurusan_ipa as $key) { ?>
						<tr>
							<td><?php echo $i; ?></td>
							<td><?php echo $key->nama_siswa; ?></td>
							<td><?php echo $key->vektor_s_ipa; ?></td>
				...
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						...
						<?php $i=1; foreach ($hasil_seleksi_jurusan_ips as $key) { ?>
						<tr>
							<td><?php echo $i; ?></td>
							<td><?php echo $key->nama_siswa; ?></td>
							<td><?php echo $key->vektor_s_ips; ?></td>
				...
				<div class="panel-heading">Hasil Final Seleksi Penjurusan</div>
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						<tr>
							<th>Rangking</th>
