...
<head>
	...
	<title><?php echo $title; ?> - Admin Rumah Harmonis</title>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="header">MANAJEMEN PENJURUSAN</li>
					<li><a href="<?php echo base_url('admin/siswa'); ?>"><i class="fa fa-users"></i> <span>Siswa</span></a></li>
					<li><a href="<?php echo base_url('admin/jurusan'); ?>"><i class="fa fa-cogs"></i> <span>Jurusan</span></a></li>
