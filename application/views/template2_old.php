						...
						<nav class="navbar navbar-default">
							<div class="navbar-header">
								...
								<a class="navbar-brand page-scroll sticky-logo" href="<?php echo base_url(); ?>">
									<h1><span><img src="<?php echo base_url('assets/img/sma2.png'); ?>" style="width: 30px"> </span>SMA N 2 TEBO</h1>
								</a>
							</div>
			...
			<div class="container ">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="contact-icon text-center">
							<div class="single-icon">
								...
								<p>
									Email: smandatebo@yahoo.co.id<br>
									<span>Web: www.sman2tebo.sch.id/</span>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="contact-icon text-center">
							<div class="single-icon">
								...
								<p>
									Lokasi: JL KI. Hajar Dewantara<br>
									<span> Kelurahan Wirotho Agung, Rimbo Bujang, Tebo, Jambi.</span>
								</p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<!-- Start Map -->
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7977.552829530017!2d102.10507730607445!3d-1.3094372859134646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x95fa589dc03906a9!2sSMAN+02+Tebo!5e0!3m2!1sen!2sid!4v1561270626871!5m2!1sen!2sid" width="100%" height="380" frameborder="0" style="border:0" allowfullscreen></iframe>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="copyright text-center">
							<p>
								&copy; Copyright <strong>Sistem Penentuan Jurusan</strong> 2019
							</p>
						</div>
					</div>
				</div>
