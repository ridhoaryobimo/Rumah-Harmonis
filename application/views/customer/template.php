...
<head>
	...
	<title><?php echo $title; ?> - Rumah Harmonis</title>
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		<header class="main-header">
			<a href="<?php echo base_url('siswa'); ?>" class="logo">
				<span class="logo-mini">
					<img src="<?php echo base_url('assets/img/imgrh/RH.png'); ?>" style="height: 40px">
				</span>
				<span class="logo-lg"><img src="<?php echo base_url('assets/img/imgrh/LOGORH.png'); ?>" style="height: 40px"> <b></b></span>
			</a>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="<?php echo base_url('siswa/nilai-ujian-nasional'); ?>"><i class="fa fa-whatsapp"></i> <span>Chat</span></a></li>
					<li><a href="<?php echo base_url('siswa/mulai-ujian'); ?>"><i class="fa fa-video-camera"></i> <span>Video Call</span></a></li>
					<li><a href="<?php echo base_url('siswa/mulai-ujian'); ?>"><i class="fa fa-users"></i> <span>Face to Face</span></a></li>
					<li><a href="<?php echo base_url('siswa/mulai-ujian'); ?>"><i class="fa fa-newspaper-o"></i> <span>Artikel</span></a></li>
		...
		<footer class="main-footer">
			<strong>©Copyright Rumah Harmonis<a href="https://adminlte.io"></a></strong>
		</footer>
	</div>
