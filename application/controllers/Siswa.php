...
class Siswa extends CI_Controller {
	...
	public function mulai_ujian()
	{
		...
		// 	if ($key->ujian_jurusan==0) {
		// 		$data1 = array(
		// 			'ujian_jurusan' => $this->input->post('jurusan'), 
		// 		);
