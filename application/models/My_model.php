...
class My_model extends CI_Model {
	...
	public function hasil_seleksi_jurusan_bhs()
	{
		$this->db->select('*');
		$this->db->from('hasil_seleksi');
		$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','left');
		$this->db->join('nilai','nilai.id_siswa = siswa.id_siswa','left');
		$this->db->join('jurusan','jurusan.id_jurusan = hasil_seleksi.id_jurusan','left');
		$this->db->order_by('hasil_seleksi.vektor_v','desc');
		$query = $this->db->get();
		return $query->result();
	}

	public function hasil_seleksi_jurusan_ipa()
	{
		$this->db->select('*');
		$this->db->from('hasil_seleksi');
		$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','left');
		$this->db->join('nilai','nilai.id_siswa = siswa.id_siswa','left');
		$this->db->join('jurusan','jurusan.id_jurusan = hasil_seleksi.id_jurusan','left');
		$this->db->order_by('hasil_seleksi.vektor_v_ipa','desc');
		$query = $this->db->get();
		return $query->result();
	}

	public function hasil_seleksi_jurusan_ips()
	{
		$this->db->select('*');
		$this->db->from('hasil_seleksi');
		$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','left');
		$this->db->join('nilai','nilai.id_siswa = siswa.id_siswa','left');
		$this->db->join('jurusan','jurusan.id_jurusan = hasil_seleksi.id_jurusan','left');
		$this->db->order_by('hasil_seleksi.vektor_v_ips','desc');
		$query = $this->db->get();
		return $query->result();
	}

	public function hasil_seleksi_final_bhs()
	{
		$this->db->select('*');
		$this->db->from('hasil_seleksi');
		$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','left');
		...
		$this->db->join('jurusan','jurusan.id_jurusan = hasil_seleksi.id_jurusan','left');
		$this->db->order_by('hasil_seleksi.vektor_v','desc');
		$this->db->where('hasil_seleksi.id_jurusan',1);
		$query = $this->db->get();
		return $query->result();
	}

	public function hasil_seleksi_final_ipa()
	{
		$this->db->select('*');
		$this->db->from('hasil_seleksi');
		$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','right');
		$this->db->join('nilai','nilai.id_siswa = siswa.id_siswa','left');
		$this->db->join('jurusan','jurusan.id_jurusan = hasil_seleksi.id_jurusan','right');
		$this->db->where('hasil_seleksi.id_jurusan',2);
		$this->db->order_by('hasil_seleksi.vektor_v_ipa','desc');
		$query = $this->db->get();
		return $query->result();
	}

	public function hasil_seleksi_final_ips()
	{
		$this->db->select('*');
		$this->db->from('hasil_seleksi');
		$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','left');
		$this->db->join('nilai','nilai.id_siswa = siswa.id_siswa','left');
		$this->db->join('jurusan','jurusan.id_jurusan = hasil_seleksi.id_jurusan','left');
		$this->db->where('hasil_seleksi.id_jurusan',3);
		$this->db->order_by('hasil_seleksi.vektor_v_ips','desc');
		$query = $this->db->get();
		return $query->result();
	}
